...
$(function(){
	$.getJSON('?_escaped_fragment_=all',function(data){
		...
		$('form').submit(function(e){
			...
			$('form *[required][value=""]').parent('label').addClass('error');
...
<label>Name<sup>*</sup><input name=name required /></label>
<label>Email<sup>*</sup><input name=email type="email" required /></label>
...
<button type=submit><span>Please complete all fields outlined in red</span>Send</button>
</form>
<div class=lb></div>
</body>
